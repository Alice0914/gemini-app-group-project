...
exports.analyzeEcoInterior = onRequest({ cors: true }, async (req, res) => {
    ...
    return cors(req, res, async () => {
        ...
        busboy.on('finish', async () => {
            ...
            try {
                ...
                const prompt = `Please analyze the interior design and give it a score out of 100. Describe the current style.
